...
public class dashboard {
    ...
    public void envios(){
        ...
        try{
            ...
            tabla+="</tbody></table>";
            //
            rs = st.executeQuery("SELECT p.`nombre`, contador.c\n" +
                                "FROM producto p\n" +
                                ",(SELECT cont.`id_producto`, COUNT(*)  AS c\n" +
                                "	FROM `contador_click` cont\n" +
                                "	GROUP BY cont.id_producto)  AS contador\n" +
                                "WHERE p.`id_producto` = contador.id_producto\n" +
            ...
            System.out.println("SQLExceptionD: " + e.getMessage());
